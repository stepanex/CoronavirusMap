...
<head>
    ...
    <meta name="description"
          content="Interaktivní mapa počtu nakažení, úmrtí a uzdravení na koronavir v České Republice podle krajů.">
    ...
    <link href="/style.css?v=1.5.3" rel="stylesheet">
...
<form id="donate" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
    ...
    <input type="image" src="/donate_icon_50w.png" name="submit" title="Přispějte na chod webu pomocí služby Paypal"
           alt="Přispějte na chod webu pomocí služby Paypal"/>
</form>
...
<div id="metInfected">
    ...
    <div id="metInfectedContainer">
        ...
        <div id="reproductionNumberTitle" class="title">
            <div id="reproductionNumberText"></div>
            <?php echo file_get_contents("question.svg") ?>
        </div>
        <input type="number" id="reproductionNumber" value="0" step="0.1" min="0"/>
        <div id="metInfectedChanceContainer">
...
<div class="footer footer_right">
    ...
    <a href="https://cs.wikipedia.org/wiki/Epidemie_koronaviru_SARS-CoV-2_v_%C4%8Cesku" id="footerRightUrl">Zdroj
        dat</a>
</div>

</body>
<script src="/map.js?v=1.5.5"></script>
</html>